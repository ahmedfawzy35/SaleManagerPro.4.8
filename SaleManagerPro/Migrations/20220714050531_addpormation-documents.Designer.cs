...
namespace SaleManagerPro.Migrations
{
    ...
    [Migration("20220714050531_addpormation-documents")]
    partial class addpormationdocuments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employee", b =>
                {
                    ...
                    b.Property<int>("IdJobDegree")
                        .HasColumnType("int");

                    b.Property<double>("Salary")
                        .HasColumnType("float");

                    b.Property<int>("StartDepartment")
                        .HasColumnType("int");

                    b.Property<int>("StartFinancialDegree")
                        .HasColumnType("int");

                    b.Property<int>("StartJob")
                        .HasColumnType("int");

                    b.Property<int>("StartJobDegree")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employees.EmployeeTransfer", b =>
                {
                    b.Property<int>("IdEmployeeTransfer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employees.PromotionDocuments", b =>
                {
                    b.Property<int>("IdPromotionDocuments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("IdPromotionDocuments");

                    b.HasIndex("IdEmployeePromotion");

                    b.HasIndex("IdUser");

                    b.ToTable("PromotionDocuments");
                });
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employees.PromotionDocuments", b =>
                {
                    b.HasOne("SaleManagerPro.Models.Employees.EmployeePromotion", "employeePromotion")
                        .WithMany("PromotionDocuments")
                        .HasForeignKey("IdEmployeePromotion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
