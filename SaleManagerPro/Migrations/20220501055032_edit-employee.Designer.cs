...
namespace SaleManagerPro.Migrations
{
    ...
    [Migration("20220501055032_edit-employee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employee", b =>
                {
                    ...
                    b.Property<int?>("FinancialDegreeIdFinancialDegree")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("JobDegreeIdGobDegree")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FinancialDegreeIdFinancialDegree");

                    b.HasIndex("JobDegreeIdGobDegree");
            ...
            modelBuilder.Entity("SaleManagerPro.Models.Employee", b =>
                {
                    b.HasOne("SaleManagerPro.Models.Employees.FinancialDegree", null)
                        .WithMany("Employees")
                        .HasForeignKey("FinancialDegreeIdFinancialDegree");

                    b.HasOne("SaleManagerPro.Models.Employees.JobDegree", null)
                        .WithMany("Employees")
                        .HasForeignKey("JobDegreeIdGobDegree");

                    b.HasOne("SaleManagerPro.Models.Employees.Job", null)
                        .WithMany("Employees")
